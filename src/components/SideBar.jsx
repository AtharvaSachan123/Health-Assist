...
const SideBar = () => {
  ...
  return (
    <div className="sticky top-5 flex h-[93vh] flex-col items-center justify-between">
      ...
      <div className="mt-12 flex w-[76px] flex-1 items-center flex-col justify-between rounded-[20px] bg-[#1c1c24] py-4">
        ...
        <Icon styles="bg-[#1c124] shadow-secondary" imageUrl={sun} />
      </div>
    </div>
  );
};
