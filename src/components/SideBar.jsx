...
const Icon=({styles,name,imageUrl,isActive,disabled,handleClick})=>{
    ...
    >
        {!isActive ?(
            ...
            <img src={imageUrl} alt="log " className={`h-6 w-6 ${isActive !== name &&'grayscale'}`} />
        )}
...
const SideBar = () => {
    ...
    return(
        <div className="sticky top-5 flex h-[93vh] flex-col items-center justify-between">
            ...
            <div className="mt-12 flex w-[76px] flex-1 items-center justify-between rounded-[20px] bg-[#1c1c24] py-24">
                ...
                <Icon styles="bg-[#1c124] showdow-secondary" imageUrl={sun}/>
